...
read op
#写轮眼辅助
ffmpeg -i $vp -vf "movie=mark.png[watermark];[in][watermark] overlay=main_w/2-overlay_w/2:main_h-overlay_h-10[out]" mark.mp4
...
#ffmpeg -ss 00:00:00.020 -i mark.mp4 -vcodec copy -acodec copy short.mp4
